# Generated by Django 5.0.1 on 2024-02-29 12:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=None, default='users/images/default.png', force_format='JPEG', keep_meta=True, null=True, quality=75, scale=0.5, size=[168, 168], upload_to='category/images')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('admin', 'Admin'), ('currier', 'Yetkazib beruvchi'), ('users', 'Foydalanuvchi'), ('operator', 'Operator'), ('manager', 'Menejer')], default='users', max_length=20)),
